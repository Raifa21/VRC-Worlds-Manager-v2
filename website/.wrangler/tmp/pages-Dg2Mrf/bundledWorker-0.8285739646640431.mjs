...
var j = /* @__PURE__ */ __name((e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), "j");
...
async function E(e, { request: t, assetsFetcher: r, ctx: s }, { path: n, searchParams: i }) {
  ...
  try {
    switch (e?.type) {
      ...
      case "override": {
        a = S(await r.fetch(N(c, e.path ?? n))), e.headers && w(a.headers, e.headers);
        break;
      }
      case "static": {
        a = await r.fetch(N(c, n));
        break;
      }
      default:
...
function Re() {
  ...
  globalThis.fetch = async (...t) => {
    ...
    return s || (s = await Q(r), s) ? s : (_e(r), e(r));
  };
}
__name(Re, "Re");
async function xe(e) {
...
var T = class {
  ...
  applyLocaleRedirects(t) {
    ...
    let { locale: { redirect: s, cookie: n } } = t, i = n && this.cookies[n], a = V(i ?? ""), o = V(this.reqCtx.request.headers.get("accept-language") ?? ""), p = [...a, ...o].map((y) => s[y]).filter(Boolean)[0];
    if (p) {
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.8285739646640431.mjs.map
