...
import { File, Info, FileQuestion, History, Plus } from 'lucide-react';
      ...
      <nav className={sidebarStyles.nav}>
        <SidebarGroup>
          ...
          <div
            className="px-3 py-2 text-sm font-medium rounded-lg hover:bg-accent/50 hover:text-accent-foreground overflow-hidden text-ellipsis whitespace-nowrap flex items-center gap-3"
            onClick={() =>
              router.push('/listview?specialFolders=recentlyVisited')
            }
          >
          ...
          <div
            className="px-3 py-2 text-sm font-medium rounded-lg hover:bg-accent/50 hover:text-accent-foreground overflow-hidden text-ellipsis whitespace-nowrap flex items-center gap-3"
            onClick={() => router.push('/listview?specialFolders=unclassified')}
          >
