        ...
        <div className="p-4">
          <div
            ...
            style={{
              ...
              height: `${rowVirtualizer.getTotalSize() / cols}px`,
            }}
          >
            {rowVirtualizer.getVirtualItems().map((worldIndex) => {
              const world = sortedAndFilteredWorlds[worldIndex.index];
              return (
